        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className="shadow-sm border">
            <CardHeader className="bg-white border-b px-6 py-4">
              <CardTitle className="flex items-center justify-between">
                <span className="text-slate-900">Order Summary</span>
                <Badge
          ...
          <Card className="shadow-sm border">
            <CardHeader className="px-6 py-4 border-b">
              <CardTitle className="text-slate-900">Order Items</CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              <div className="space-y-4">
                {order.order_items.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center space-x-4 p-4 bg-white rounded-lg border hover:shadow-sm transition"
                  >
                    <img
                      src={
          ...
          <Card className="shadow-sm border">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-xs text-slate-500">
                Your order will be processed and you'll receive updates
                via WhatsApp.
              </p>
            </CardContent>
          </Card>
